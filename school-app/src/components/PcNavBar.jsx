...
const PcNavbar = () => {
  ...
  return (
    <div>
      <nav className=" w-full flex flex-wrap items-center mx-auto p-2 bg-[#255393] text-white pl-3 md:pl-10 shadow-lg shadow-slate-500 rounded-b-lg">
        ...
        <ul className="relative font-[Dangrek] flex flex-col md:flex-row justify-between mx-auto gap-5 lg:gap-12 md:text-base ">
          ...
          {
            isToggle?<div className='absolute top-7 bg-[#255393] border-[2px] border-[#19345b] rounded-md p-3'><Link to="/about-kms"><li className='hover:bg-[#3e669f] p-2 rounded-md'>About KMS</li></Link><Link to="/achievements"><li className='hover:bg-[#3e669f] p-2 rounded-md'>Achievements</li></Link> </div>:<div className='hidden'><h1>asdsadasdasd</h1></div>
          }
          ...
          {
            isToggleEvent?<div className='absolute top-7 border-[2px] border-[#19345b] right-80 lg:right-96 w-40 text-center bg-[#255393] rounded-md p-3'><Link to="/event"><li className='hover:bg-[#3e669f] p-2 rounded-md'>Events</li></Link><Link to="/news"><li className='hover:bg-[#3e669f] p-2 rounded-md'>News</li></Link> </div>:<div className='hidden'><h1>asdsadasdasd</h1></div>
          }
