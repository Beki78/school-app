  ...
  return (
    <div className="bg-[#BFD7ED]">
      <footer className="flex flex-col md:flex-row items-center gap-10 md:gap-20 p-20 px-20 justify-center">
        <div>
          <h1 className="text-4xl text-[#003B73] font-[Dangrek] text-center pb-6">
            Contact us
          </h1>
          <div className="flex gap-3 items-center pb-3">
            <FaLocationDot className="text-2xl text-[#003B73]" />
            <h1 className="font-[poppins]  text-[#0074B7]">
              Kebena square, Addis Ababa, Ethiopia
            </h1>
          </div>
          <div className="flex gap-3 items-center pb-3">
            <FaPhoneVolume className="text-2xl text-[#003B73]" />
            <h1 className="font-[poppins] text-[#0074B7]">+211-23-26-67-36</h1>
          </div>
          <div className="flex gap-3 items-center pb-3">
            <MdEmail className="text-2xl text-[#003B73]" />
            <h1 className="font-[poppins] text-[#0074B7]">
              kidanemehretschool@gmail.com
            </h1>
          </div>
        </div>
        <div>
      ...
      <div className="w-full bg-[#003B73] font-[Dangrek] text-[#BFD7ED] text-center py-2">
